...
namespace QRCodeManagement.Controllers
{
    public partial class AccountController
    {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> UpdateMyProfile()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.UpdateMyProfile);
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string UpdateMyProfile = "UpdateMyProfile";
        ...
        public class ActionNameConstants
        {
            ...
            public const string UpdateMyProfile = "UpdateMyProfile";
        ...
        static readonly ActionParamsClass_UpdateMyProfile s_params_UpdateMyProfile = new ActionParamsClass_UpdateMyProfile();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_UpdateMyProfile UpdateMyProfileParams { get { return s_params_UpdateMyProfile; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_UpdateMyProfile
        {
        ...
        public class ViewsClass
        {
            ...
            public partial class _PartialsClass
            {
                ...
                public class _ViewNamesClass
                {
                    public readonly string ForgotPwdForm = "ForgotPwdForm";
                    public readonly string LoginForm = "LoginForm";
                }
                public readonly string ForgotPwdForm = "~/Views/Account/Partials/ForgotPwdForm.cshtml";
                public readonly string LoginForm = "~/Views/Account/Partials/LoginForm.cshtml";
            }
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : QRCodeManagement.Controllers.AccountController
    {
        ...
        [NonAction]
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, QRCodeManagement.Models.ViewModels.LoginViewModel model, string returnUrl);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Login(QRCodeManagement.Models.ViewModels.LoginViewModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
        ...
        [NonAction]
        partial void ChangePasswordOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, QRCodeManagement.Models.ViewModels.ChangePasswordViewModel model);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> ChangePassword(QRCodeManagement.Models.ViewModels.ChangePasswordViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ChangePassword);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        [NonAction]
        partial void UpdateMyProfileOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, QRCodeManagement.Models.ViewModels.MyProfileViewModel userModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> UpdateMyProfile(QRCodeManagement.Models.ViewModels.MyProfileViewModel userModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.UpdateMyProfile);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "userModel", userModel);
            UpdateMyProfileOverride(callInfo, userModel);
            return System.Threading.Tasks.Task.FromResult(callInfo as System.Web.Mvc.ActionResult);
        }
        ...
        [NonAction]
        partial void ForgotPasswordOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, QRCodeManagement.Models.ViewModels.ForgotPasswordViewModel model);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> ForgotPassword(QRCodeManagement.Models.ViewModels.ForgotPasswordViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ForgotPassword);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        [NonAction]
        partial void ResetPasswordOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, QRCodeManagement.Models.ViewModels.ResetPasswordViewModel model);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> ResetPassword(QRCodeManagement.Models.ViewModels.ResetPasswordViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ResetPassword);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
