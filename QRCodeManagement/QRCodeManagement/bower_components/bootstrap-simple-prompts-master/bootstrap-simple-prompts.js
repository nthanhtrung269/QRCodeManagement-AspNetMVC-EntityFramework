...
'
        ...
        if (typeof warning === "undefined" || warning == false) {
            ...
            markup += '<button type="button" class="btn btn-primary leave ok btn-success" data-dismiss="modal">Ok</button>'
        } else {
            if (confirm) markup += '<button type="button" class="btn btn-primary leave cancel">Cancel</button>';
            markup += '<button type="button" class="btn btn-danger leave ok btn-success" data-dismiss="modal">Ok</button>'
        }
        markup += '\
            </div> \
        </div> \
